...
func NewKedaReconciler(client client.Client,
	...
	scaledObject, err := createKedaScaledObject(componentMeta, componentExt, autoscalerConfig, otelCollectorConfig)
	if err != nil {
		return nil, err
	}
...
func createKedaScaledObject(componentMeta metav1.ObjectMeta,
	...
	triggers, err := getKedaMetrics(componentMeta, componentExtension, otelCollectorConfig)
	if err != nil {
		return nil, err
	}
